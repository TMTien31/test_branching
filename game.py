...
#Cung cấp các hàm liên quan đến hệ thống, như thoát chương trình.
import sys

#Cung cấp các hằng số và sự kiện của Pygame.
from pygame.locals import *

#Import các hằng số từ module constants và đặt tên là SOKOBAN
...
#Thư viện giúp tự động hóa các thao tác bàn phím và chuột.
from pyautogui import press, typewrite, hotkey

#Dùng để tạo và quản lý các luồng (threads) và thời gian.
import _thread
import time

#strategy là 1 list các nước đi, duyệt qua và dùng lệnh press để tự động thao tác
